          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                <li><a href="index_oditur.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron"></span></a>
                </li>
                ...
                <li><a href="index_oditur.php?page=tambah_berkas"><i class="glyphicon glyphicon-log-in"></i> Input Berkas Perkara <span class="fa fa-chevron"></span></a>
                </li>
                ...
                <li><a href="index_oditur.php?page=logout"><i class="fa fa-sign-out"></i> Logout <span class="fa fa-chevron"></span></a>
                </li>
                <li> Selamat datang, <?= $_SESSION['nama_lengkap'] ?> anda berhasil login sebagai staff Oditur </li>
              </ul>
            </div>
          </div>
          <!-- /sidebar menu -->
      ...
      <div class="right_col" role="main">
        ...
        switch ($queries['page']) {
          ...
          case 'data_berkas_oditur':
            # code...
            include 'data_berkas_oditur.php';
            break;
          case 'edit_berkas':
            # code...
