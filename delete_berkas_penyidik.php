...
if (isset($_GET['kode_registrasi'])) {
	...
	if (mysqli_num_rows($cek) > 0) {
		...
		if ($del) {
			echo '<script>alert("Berhasil menghapus data."); document.location="index_penyidik.php?page=tampil_berkas_penyidik";</script>';
		} else {
			echo '<script>alert("Gagal menghapus data."); document.location="?index_penyidik.php?page=tampil_berkas_penyidik";</script>';
		}
	}
}	
