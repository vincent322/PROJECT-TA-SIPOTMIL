...
<div class="container" style="margin-top:20px">
	<center>
		<font size="6">Berkas Lahkara</font>
	</center>
	<hr>
	<div id="search">
			...
			<table class="table table-striped jambo_table bulk_action">
				...
				<tbody>
					<div class="item form-group">
						...
						$sql = mysqli_query($koneksi, "SELECT * FROM berkas where status_berkas ='Pending'") or die(mysqli_error($koneksi));
						...
						<tr>
							...
							<td>
							<a href="acc_kepala.php?kode_registrasi=' . $data['kode_registrasi'] . '" class="btn btn-primary btn-sm">Acc Kepala</a>
