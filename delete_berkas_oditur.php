...
if (isset($_GET['kode_registrasi'])) {
	...
	if (mysqli_num_rows($cek) > 0) {
		...
		if ($del) {
			echo '<script>alert("Berhasil menghapus data."); document.location="index_oditur.php?page=tampil_berkas_oditur";</script>';
		} else {
			echo '<script>alert("Gagal menghapus data."); document.location="?index_oditur.php?page=tampil_berkas_oditur";</script>';
		}
	}
}	
